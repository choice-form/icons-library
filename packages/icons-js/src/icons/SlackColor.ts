...
const SlackColor: Icon = {
  ...
  toSvg(attrs = {}) {
    const defaultAttrs = {
      ...
      d: "M.667 9.955a1.467 1.467 0 1 0 2.933 0V8.49H2.133A1.467 1.467 0 0 0 .667 9.955M4.578 9.955v3.912a1.467 1.467 0 1 0 2.933 0V9.955a1.467 1.467 0 0 0-2.933 0",
      mask: "url(#a)",
