...
const GoogleColor: Icon = {
  ...
  toSvg(attrs = {}) {
    const defaultAttrs = {
      ...
      d: "M10.48 11.72a4.66 4.66 0 0 1-2.48.613A4.34 4.34 0 0 1 3.889 9.36L1.43 11.255A7.34 7.34 0 0 0 8 15.333a7.3 7.3 0 0 0 4.92-1.733z",
      mask: "url(#a)",
