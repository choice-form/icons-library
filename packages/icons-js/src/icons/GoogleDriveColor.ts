...
/**
 * GoogleDriveColor icon
 */
const GoogleDriveColor: Icon = {
  name: 'google-drive-color',
  toSvg(attrs = {}) {
    const defaultAttrs = {
      ...
      d: "m13.453 5.857-2.328-4.032a1.66 1.66 0 0 0-.605-.605L8 5.582l2.96 5.132h5.03a1.66 1.66 0 0 0-.22-.825z",
      mask: "url(#a)",
...
export default GoogleDriveColor;
