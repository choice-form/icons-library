...
/**
 * trigger-started-by-date-or-time-field icon
 */
const TriggerStartedByDateOrTimeField: Icon = {
  name: 'trigger-started-by-date-or-time-field',
  toSvg(attrs = {}) {
...
export default TriggerStartedByDateOrTimeField;
