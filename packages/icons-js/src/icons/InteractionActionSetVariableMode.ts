...
/**
 * InteractionActionSetVariableMode icon
 */
const InteractionActionSetVariableMode: Icon = {
  ...
  toSvg(attrs = {}) {
    const defaultAttrs = {
      ...
      d: "m7.5 6 1.15-1.15a1.2 1.2 0 0 1 1.702.002l.948.948a1.2 1.2 0 0 1 .013 1.717L6.95 11.9",
