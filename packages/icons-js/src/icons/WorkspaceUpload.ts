...
const WorkspaceUpload: Icon = {
  ...
  toSvg(attrs = {}) {
    const defaultAttrs = {
      ...
      "fill-opacity": ".25",
      d: "M12.5 14.5h-3a1 1 0 0 1-1-1v-3a1 1 0 0 1 1-1h3a1 1 0 0 1 1 1v3a1 1 0 0 1-1 1M5.5 9.5h-3a1 1 0 0 0-1 1v3a1 1 0 0 0 1 1h3a1 1 0 0 0 1-1v-3a1 1 0 0 0-1-1M11.5 6.5v-5m0 0 2 2m-2-2-2 2",
