...
/**
 * circle-check-large icon
 */
const CircleCheckLarge: Icon = {
  name: 'circle-check-large',
  toSvg(attrs = {}) {
...
export default CircleCheckLarge;
