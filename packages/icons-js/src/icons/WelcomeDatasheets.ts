...
/**
 * WelcomeDatasheets icon
 */
const WelcomeDatasheets: Icon = {
  name: 'welcome-datasheets',
  toSvg(attrs = {}) {
    const defaultAttrs = {
      ...
      d: "M10.5 6.5 12 5m.5-4.5L11 2m0 0L9.5 3.5 12 5m-1-3 2.5 1.5L12 5M13.5 13.5h4",
      "fill-opacity": ".25",
      "stroke-opacity": ".25",
...
export default WelcomeDatasheets;
