...
/**
 * ActionPackagedNode icon
 */
const ActionPackagedNode: Icon = {
  name: 'action-packaged-node',
  toSvg(attrs = {}) {
    const defaultAttrs = {
      ...
      d: "M3.5 7.5v3l2 1M11.5 7.5v3l-2 1M5.5 4.5l2-1 2 1",
...
export default ActionPackagedNode;
