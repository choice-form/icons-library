...
const FileDuplicate: Icon = {
  ...
  toSvg(attrs = {}) {
    const defaultAttrs = {
      ...
      viewBox: "0 0 16 16",
      "fill-opacity": ".25",
      d: "M4.5 5.5h-1a1 1 0 0 0-1 1v7a1 1 0 0 0 1 1h5a1 1 0 0 0 1-1v-1",
      stroke: "currentColor",
