...
const EmptySurvey: Icon = {
  ...
  toSvg(attrs = {}) {
    const defaultAttrs = {
      ...
      viewBox: "0 0 16 16",
      "fill-opacity": ".25",
      d: "M8.5 1.5h-5a1 1 0 0 0-1 1v11a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1v-8m-4-4 4 4m-4-4v3a1 1 0 0 0 1 1h3",
      stroke: "currentColor",
